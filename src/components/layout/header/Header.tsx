  ...
  return (
    <header className="fixed w-full h-18 z-20 shadow-lg shadow-[#0067BB]/50 bg-[#030014]">
      <div className="flex justify-between items-center 2xl:px-16 px-5 py-3 relative">
        ...
        <div
          className={`lg:relative absolute top-16 lg:top-0 right-0 p-0 h-auto lg:bg-transparent bg-[#030014] w-full lg:w-auto transform transition-all duration-500 ease-in-out ${
            isOpen
          ...
          <ul className="flex lg:flex-row flex-col gap-6">
            <li className="text-lg font-semibold hover:text-purple-500 transition-colors">
        ...
        <div
          ...
          onClick={toggleMenu}>
          <span
            className={`block h-[2px] bg-[#fff] transition-all duration-300 ${
          ...
          <span
            className={`block h-0.5 bg-[#fff] transition-all duration-300 ${
